...
export const ServiceCard = ({ service }) => {
  return (
    <div className={`group/cart services relative w-full h-full z-20`}>
      <span
      ...
      <RightArrow
        style={`hidden sm:inline-block absolute -left-9 top-1/2 -translate-y-1/2 w-6 h-6 text-black \
        dark:text-white`}
      />
      <div
      ...
      >
        <h2
          className={`grid place-items-center h-full text-center text-[12px] font-bold \
           group-hover/cart:border-b-[1px] group-hover/cart:border-black p-2 bg-white   \
